...
let expName = 'CGTriskyDMtask';  // from the Builder filename that created this script
let expInfo = {
    'participant': '',
};
...
function settingUpRoutineBegin(snapshot) {
  return async function () {
    ...
    psychoJS.experiment.addData('settingUp.started', globalClock.getTime());
...
function settingUpRoutineEnd(snapshot) {
  return async function () {
    ...
    psychoJS.experiment.addData('settingUp.stopped', globalClock.getTime());
...
function SpanGeneralInstructionsRoutineBegin(snapshot) {
  return async function () {
    ...
    continueRoutine = true; // until we're told otherwise
    // update component parameters for each repeat
    psychoJS.experiment.addData('SpanGeneralInstructions.started', globalClock.getTime());
  ...
  return async function () {
    ...
    if (movealong.status === PsychoJS.Status.STARTED) {
      ...
      if (_movealong_allKeys.length > 0) {
        ...
        movealong.duration = _movealong_allKeys[_movealong_allKeys.length - 1].duration;
...
function SpanGeneralInstructionsRoutineEnd(snapshot) {
  return async function () {
    ...
    psychoJS.experiment.addData('SpanGeneralInstructions.stopped', globalClock.getTime());
    ...
    if (typeof movealong.keys !== 'undefined') {  // we had a response
        ...
        psychoJS.experiment.addData('movealong.duration', movealong.duration);
        routineTimer.reset();
        }
...
function SpanReminder1RoutineBegin(snapshot) {
  return async function () {
    ...
    continueRoutine = true; // until we're told otherwise
    // update component parameters for each repeat
    psychoJS.experiment.addData('SpanReminder1.started', globalClock.getTime());
    ...
    SpanReminder1Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
  ...
  return async function () {
    ...
    if (movealong2.status === PsychoJS.Status.STARTED) {
      ...
      if (_movealong2_allKeys.length > 0) {
        ...
        movealong2.duration = _movealong2_allKeys[_movealong2_allKeys.length - 1].duration;
        // a response ends the routine
        continueRoutine = false;
      }
    }
...
function SpanReminder1RoutineEnd(snapshot) {
  return async function () {
    ...
    psychoJS.experiment.addData('SpanReminder1.stopped', globalClock.getTime());
    // update the trial handler
    if (currentLoop instanceof MultiStairHandler) {
    ...
    if (typeof movealong2.keys !== 'undefined') {  // we had a response
        ...
        psychoJS.experiment.addData('movealong2.duration', movealong2.duration);
        routineTimer.reset();
        }
...
function SpanReminder2RoutineBegin(snapshot) {
  return async function () {
    ...
    continueRoutine = true; // until we're told otherwise
    // update component parameters for each repeat
    psychoJS.experiment.addData('SpanReminder2.started', globalClock.getTime());
    ...
    SpanReminder2Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
  ...
  return async function () {
    ...
    if (movealong3.status === PsychoJS.Status.STARTED) {
      ...
      if (_movealong3_allKeys.length > 0) {
        ...
        movealong3.duration = _movealong3_allKeys[_movealong3_allKeys.length - 1].duration;
        // a response ends the routine
        continueRoutine = false;
      }
    }
...
function SpanReminder2RoutineEnd(snapshot) {
  return async function () {
    ...
    psychoJS.experiment.addData('SpanReminder2.stopped', globalClock.getTime());
    // update the trial handler
    if (currentLoop instanceof MultiStairHandler) {
    ...
    if (typeof movealong3.keys !== 'undefined') {  // we had a response
        ...
        psychoJS.experiment.addData('movealong3.duration', movealong3.duration);
        routineTimer.reset();
        }
...
function FSInstructionsRoutineBegin(snapshot) {
  return async function () {
    ...
    continueRoutine = true; // until we're told otherwise
    // update component parameters for each repeat
    psychoJS.experiment.addData('FSInstructions.started', globalClock.getTime());
...
function FSInstructionsRoutineEnd(snapshot) {
  return async function () {
    ...
    psychoJS.experiment.addData('FSInstructions.stopped', globalClock.getTime());
    // update the trial handler
    if (currentLoop instanceof MultiStairHandler) {
...
function ShowNumbersPracticeRoutineBegin(snapshot) {
  return async function () {
    ...
    // update component parameters for each repeat
    psychoJS.experiment.addData('ShowNumbersPractice.started', globalClock.getTime());
...
function ShowNumbersPracticeRoutineEnd(snapshot) {
  return async function () {
    ...
    psychoJS.experiment.addData('ShowNumbersPractice.stopped', globalClock.getTime());
    // Routines running outside a loop should always advance the datafile row
    if (currentLoop === psychoJS.experiment) {
      psychoJS.experiment.nextEntry(snapshot);
    }
...
function RecallPracticeRoutineBegin(snapshot) {
  return async function () {
    ...
    continueRoutine = true; // until we're told otherwise
    // update component parameters for each repeat
    psychoJS.experiment.addData('RecallPractice.started', globalClock.getTime());
...
function RecallPracticeRoutineEnd(snapshot) {
  return async function () {
    ...
    psychoJS.experiment.addData('RecallPractice.stopped', globalClock.getTime());
...
function FeedbackPracticeRoutineBegin(snapshot) {
  return async function () {
    ...
    // update component parameters for each repeat
    psychoJS.experiment.addData('FeedbackPractice.started', globalClock.getTime());
...
function FeedbackPracticeRoutineEnd(snapshot) {
  return async function () {
    ...
    psychoJS.experiment.addData('FeedbackPractice.stopped', globalClock.getTime());
    // Routines running outside a loop should always advance the datafile row
    if (currentLoop === psychoJS.experiment) {
      psychoJS.experiment.nextEntry(snapshot);
    }
...
function StartRealFSRoutineBegin(snapshot) {
  return async function () {
    ...
    continueRoutine = true; // until we're told otherwise
    // update component parameters for each repeat
    psychoJS.experiment.addData('StartRealFS.started', globalClock.getTime());
  ...
  return async function () {
    ...
    if (startFSreal.status === PsychoJS.Status.STARTED) {
      ...
      if (_startFSreal_allKeys.length > 0) {
        ...
        startFSreal.duration = _startFSreal_allKeys[_startFSreal_allKeys.length - 1].duration;
        // a response ends the routine
        continueRoutine = false;
      }
    }
...
function StartRealFSRoutineEnd(snapshot) {
  return async function () {
    ...
    psychoJS.experiment.addData('StartRealFS.stopped', globalClock.getTime());
    // update the trial handler
    if (currentLoop instanceof MultiStairHandler) {
    ...
    if (typeof startFSreal.keys !== 'undefined') {  // we had a response
        ...
        psychoJS.experiment.addData('startFSreal.duration', startFSreal.duration);
        routineTimer.reset();
        }
...
function selectNumbersRoutineBegin(snapshot) {
  return async function () {
    ...
    continueRoutine = true; // until we're told otherwise
    // update component parameters for each repeat
    psychoJS.experiment.addData('selectNumbers.started', globalClock.getTime());
...
function selectNumbersRoutineEnd(snapshot) {
  return async function () {
    ...
    psychoJS.experiment.addData('selectNumbers.stopped', globalClock.getTime());
...
function ShowNumbersRoutineBegin(snapshot) {
  return async function () {
    ...
    routineTimer.add(2.000000);
    // update component parameters for each repeat
    psychoJS.experiment.addData('ShowNumbers.started', globalClock.getTime());
...
function ShowNumbersRoutineEnd(snapshot) {
  return async function () {
    ...
    psychoJS.experiment.addData('ShowNumbers.stopped', globalClock.getTime());
...
function FStoBStransitionRoutineBegin(snapshot) {
  return async function () {
    ...
    continueRoutine = true; // until we're told otherwise
    // update component parameters for each repeat
    psychoJS.experiment.addData('FStoBStransition.started', globalClock.getTime());
  ...
  return async function () {
    ...
    if (moveToBS.status === PsychoJS.Status.STARTED) {
      ...
      if (_moveToBS_allKeys.length > 0) {
        ...
        moveToBS.duration = _moveToBS_allKeys[_moveToBS_allKeys.length - 1].duration;
        // a response ends the routine
        continueRoutine = false;
      }
    }
...
function FStoBStransitionRoutineEnd(snapshot) {
  return async function () {
    ...
    psychoJS.experiment.addData('FStoBStransition.stopped', globalClock.getTime());
    // update the trial handler
    if (currentLoop instanceof MultiStairHandler) {
    ...
    if (typeof moveToBS.keys !== 'undefined') {  // we had a response
        ...
        psychoJS.experiment.addData('moveToBS.duration', moveToBS.duration);
        routineTimer.reset();
        }
...
function InstructionsBSRoutineBegin(snapshot) {
  return async function () {
    ...
    continueRoutine = true; // until we're told otherwise
    // update component parameters for each repeat
    psychoJS.experiment.addData('InstructionsBS.started', globalClock.getTime());
  ...
  return async function () {
    ...
    if (startBSprac.status === PsychoJS.Status.STARTED) {
      ...
      if (_startBSprac_allKeys.length > 0) {
        ...
        startBSprac.duration = _startBSprac_allKeys[_startBSprac_allKeys.length - 1].duration;
        // a response ends the routine
        continueRoutine = false;
      }
    }
...
function InstructionsBSRoutineEnd(snapshot) {
  return async function () {
    ...
    psychoJS.experiment.addData('InstructionsBS.stopped', globalClock.getTime());
    // update the trial handler
    if (currentLoop instanceof MultiStairHandler) {
    ...
    if (typeof startBSprac.keys !== 'undefined') {  // we had a response
        ...
        psychoJS.experiment.addData('startBSprac.duration', startBSprac.duration);
        routineTimer.reset();
        }
...
function showNumbersPracticeBSRoutineBegin(snapshot) {
  return async function () {
    ...
    routineTimer.add(2.000000);
    // update component parameters for each repeat
    psychoJS.experiment.addData('showNumbersPracticeBS.started', globalClock.getTime());
...
function showNumbersPracticeBSRoutineEnd(snapshot) {
  return async function () {
    ...
    psychoJS.experiment.addData('showNumbersPracticeBS.stopped', globalClock.getTime());
    // Routines running outside a loop should always advance the datafile row
    if (currentLoop === psychoJS.experiment) {
      psychoJS.experiment.nextEntry(snapshot);
    }
...
function recallPracticeBSRoutineBegin(snapshot) {
  return async function () {
    ...
    continueRoutine = true; // until we're told otherwise
    // update component parameters for each repeat
    psychoJS.experiment.addData('recallPracticeBS.started', globalClock.getTime());
...
function recallPracticeBSRoutineEnd(snapshot) {
  return async function () {
    ...
    psychoJS.experiment.addData('recallPracticeBS.stopped', globalClock.getTime());
...
function feedbackPracticeBSRoutineBegin(snapshot) {
  return async function () {
    ...
    routineTimer.add(1.000000);
    // update component parameters for each repeat
    psychoJS.experiment.addData('feedbackPracticeBS.started', globalClock.getTime());
...
function feedbackPracticeBSRoutineEnd(snapshot) {
  return async function () {
    ...
    psychoJS.experiment.addData('feedbackPracticeBS.stopped', globalClock.getTime());
    // Routines running outside a loop should always advance the datafile row
    if (currentLoop === psychoJS.experiment) {
      psychoJS.experiment.nextEntry(snapshot);
    }
...
function startRealBSRoutineBegin(snapshot) {
  return async function () {
    ...
    continueRoutine = true; // until we're told otherwise
    // update component parameters for each repeat
    psychoJS.experiment.addData('startRealBS.started', globalClock.getTime());
  ...
  return async function () {
    ...
    if (startBSreal.status === PsychoJS.Status.STARTED) {
      ...
      if (_startBSreal_allKeys.length > 0) {
        ...
        startBSreal.duration = _startBSreal_allKeys[_startBSreal_allKeys.length - 1].duration;
        // a response ends the routine
        continueRoutine = false;
      }
    }
...
function startRealBSRoutineEnd(snapshot) {
  return async function () {
    ...
    psychoJS.experiment.addData('startRealBS.stopped', globalClock.getTime());
    // update the trial handler
    if (currentLoop instanceof MultiStairHandler) {
    ...
    if (typeof startBSreal.keys !== 'undefined') {  // we had a response
        ...
        psychoJS.experiment.addData('startBSreal.duration', startBSreal.duration);
        routineTimer.reset();
        }
...
function selectNumbersBSRoutineBegin(snapshot) {
  return async function () {
    ...
    continueRoutine = true; // until we're told otherwise
    // update component parameters for each repeat
    psychoJS.experiment.addData('selectNumbersBS.started', globalClock.getTime());
...
function selectNumbersBSRoutineEnd(snapshot) {
  return async function () {
    ...
    psychoJS.experiment.addData('selectNumbersBS.stopped', globalClock.getTime());
...
function showNumbersBSRoutineBegin(snapshot) {
  return async function () {
    ...
    routineTimer.add(2.000000);
    // update component parameters for each repeat
    psychoJS.experiment.addData('showNumbersBS.started', globalClock.getTime());
...
function showNumbersBSRoutineEnd(snapshot) {
  return async function () {
    ...
    psychoJS.experiment.addData('showNumbersBS.stopped', globalClock.getTime());
...
function RecallBSRoutineBegin(snapshot) {
  return async function () {
    ...
    continueRoutine = true; // until we're told otherwise
    // update component parameters for each repeat
    psychoJS.experiment.addData('RecallBS.started', globalClock.getTime());
    textboxBS.setText('');
    textboxBS.refresh();
...
function RecallBSRoutineEnd(snapshot) {
  return async function () {
    ...
    psychoJS.experiment.addData('RecallBS.stopped', globalClock.getTime());
...
function FeedbackBSRoutineBegin(snapshot) {
  return async function () {
    ...
    routineTimer.add(1.000000);
    // update component parameters for each repeat
    psychoJS.experiment.addData('FeedbackBS.started', globalClock.getTime());
...
function FeedbackBSRoutineEnd(snapshot) {
  return async function () {
    ...
    psychoJS.experiment.addData('FeedbackBS.stopped', globalClock.getTime());
    // Routines running outside a loop should always advance the datafile row
    if (currentLoop === psychoJS.experiment) {
      psychoJS.experiment.nextEntry(snapshot);
    }
