...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='/Users/justinblake/Documents/GitHub/gpr/2_tasks/working_files/gpr_task_folder/cgt_digitSpan/gprDigitSpan_lastrun.py',
...
def setupDevices(expInfo, thisExp, win):
    ...
    if deviceManager.getDevice('movealong') is None:
        # initialise movealong
        movealong = deviceManager.addDevice(
            deviceClass='keyboard',
            deviceName='movealong',
        )
    if deviceManager.getDevice('movealong2') is None:
        # initialise movealong2
        movealong2 = deviceManager.addDevice(
            deviceClass='keyboard',
            deviceName='movealong2',
        )
    if deviceManager.getDevice('movealong3') is None:
        # initialise movealong3
        movealong3 = deviceManager.addDevice(
            deviceClass='keyboard',
            deviceName='movealong3',
        )
    ...
    if deviceManager.getDevice('startFSreal') is None:
        # initialise startFSreal
        startFSreal = deviceManager.addDevice(
            deviceClass='keyboard',
            deviceName='startFSreal',
        )
    if deviceManager.getDevice('moveToBS') is None:
        # initialise moveToBS
        moveToBS = deviceManager.addDevice(
            deviceClass='keyboard',
            deviceName='moveToBS',
        )
    if deviceManager.getDevice('startBSprac') is None:
        # initialise startBSprac
        startBSprac = deviceManager.addDevice(
            deviceClass='keyboard',
            deviceName='startBSprac',
        )
    if deviceManager.getDevice('startBSreal') is None:
        # initialise startBSreal
        startBSreal = deviceManager.addDevice(
            deviceClass='keyboard',
            deviceName='startBSreal',
        )
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    GenInsText = visual.TextStim(win=win, name='GenInsText',
        ...
        languageStyle='LTR',
        depth=-1.0);
    movealong = keyboard.Keyboard(deviceName='movealong')
    ...
    Reminder1 = visual.TextStim(win=win, name='Reminder1',
        ...
        languageStyle='LTR',
        depth=0.0);
    movealong2 = keyboard.Keyboard(deviceName='movealong2')
    ...
    Reminder2 = visual.TextStim(win=win, name='Reminder2',
        ...
        languageStyle='LTR',
        depth=0.0);
    movealong3 = keyboard.Keyboard(deviceName='movealong3')
    ...
    praccomplete = visual.TextStim(win=win, name='praccomplete',
        ...
        languageStyle='LTR',
        depth=0.0);
    startFSreal = keyboard.Keyboard(deviceName='startFSreal')
    ...
    roundTransition = visual.TextStim(win=win, name='roundTransition',
        ...
        languageStyle='LTR',
        depth=0.0);
    moveToBS = keyboard.Keyboard(deviceName='moveToBS')
    ...
    BSGenInsText = visual.TextStim(win=win, name='BSGenInsText',
        ...
        languageStyle='LTR',
        depth=0.0);
    startBSprac = keyboard.Keyboard(deviceName='startBSprac')
    ...
    praccompleteBS = visual.TextStim(win=win, name='praccompleteBS',
        ...
        languageStyle='LTR',
        depth=0.0);
    startBSreal = keyboard.Keyboard(deviceName='startBSreal')
    ...
    thisExp.addData('settingUp.started', globalClock.getTime(format='float'))
    ...
    thisExp.addData('settingUp.stopped', globalClock.getTime(format='float'))
    thisExp.nextEntry()
    ...
    continueRoutine = True
    # update component parameters for each repeat
    thisExp.addData('SpanGeneralInstructions.started', globalClock.getTime(format='float'))
    movealong.keys = []
    movealong.rt = []
    _movealong_allKeys = []
    # keep track of which components have finished
    ...
    for thisComponent in SpanGeneralInstructionsComponents:
        if hasattr(thisComponent, "setAutoDraw"):
            thisComponent.setAutoDraw(False)
    thisExp.addData('SpanGeneralInstructions.stopped', globalClock.getTime(format='float'))
    # check responses
    ...
    continueRoutine = True
    # update component parameters for each repeat
    thisExp.addData('SpanReminder1.started', globalClock.getTime(format='float'))
    movealong2.keys = []
    movealong2.rt = []
    _movealong2_allKeys = []
    # keep track of which components have finished
    ...
    for thisComponent in SpanReminder1Components:
        if hasattr(thisComponent, "setAutoDraw"):
            thisComponent.setAutoDraw(False)
    thisExp.addData('SpanReminder1.stopped', globalClock.getTime(format='float'))
    # check responses
    ...
    continueRoutine = True
    # update component parameters for each repeat
    thisExp.addData('SpanReminder2.started', globalClock.getTime(format='float'))
    movealong3.keys = []
    movealong3.rt = []
    _movealong3_allKeys = []
    # keep track of which components have finished
    ...
    for thisComponent in SpanReminder2Components:
        if hasattr(thisComponent, "setAutoDraw"):
            thisComponent.setAutoDraw(False)
    thisExp.addData('SpanReminder2.stopped', globalClock.getTime(format='float'))
    # check responses
    ...
    continueRoutine = True
    # update component parameters for each repeat
    thisExp.addData('FSInstructions.started', globalClock.getTime(format='float'))
    startPractice.keys = []
    startPractice.rt = []
    ...
    for thisComponent in FSInstructionsComponents:
        if hasattr(thisComponent, "setAutoDraw"):
            thisComponent.setAutoDraw(False)
    thisExp.addData('FSInstructions.stopped', globalClock.getTime(format='float'))
    # check responses
    ...
    for thisTrialFSPractice in trialFSPractice:
        ...
        for thisDigitLoopPractice in DigitLoopPractice:
            ...
            continueRoutine = True
            # update component parameters for each repeat
            thisExp.addData('ShowNumbersPractice.started', globalClock.getTime(format='float'))
            ...
            for thisComponent in ShowNumbersPracticeComponents:
                if hasattr(thisComponent, "setAutoDraw"):
                    thisComponent.setAutoDraw(False)
            thisExp.addData('ShowNumbersPractice.stopped', globalClock.getTime(format='float'))
        ...
        continueRoutine = True
        # update component parameters for each repeat
        thisExp.addData('RecallPractice.started', globalClock.getTime(format='float'))
        ...
        for thisComponent in RecallPracticeComponents:
            if hasattr(thisComponent, "setAutoDraw"):
                thisComponent.setAutoDraw(False)
        thisExp.addData('RecallPractice.stopped', globalClock.getTime(format='float'))
        ...
        continueRoutine = True
        # update component parameters for each repeat
        thisExp.addData('FeedbackPractice.started', globalClock.getTime(format='float'))
        ...
        for thisComponent in FeedbackPracticeComponents:
            if hasattr(thisComponent, "setAutoDraw"):
                thisComponent.setAutoDraw(False)
        thisExp.addData('FeedbackPractice.stopped', globalClock.getTime(format='float'))
        # using non-slip timing so subtract the expected duration of this Routine (unless ended on request)
        if routineForceEnded:
            routineTimer.reset()
        else:
    ...
    continueRoutine = True
    # update component parameters for each repeat
    thisExp.addData('StartRealFS.started', globalClock.getTime(format='float'))
    startFSreal.keys = []
    startFSreal.rt = []
    ...
    for thisComponent in StartRealFSComponents:
        if hasattr(thisComponent, "setAutoDraw"):
            thisComponent.setAutoDraw(False)
    thisExp.addData('StartRealFS.stopped', globalClock.getTime(format='float'))
    # check responses
    ...
    for thisTrialsFS in trialsFS:
        ...
        continueRoutine = True
        # update component parameters for each repeat
        thisExp.addData('selectNumbers.started', globalClock.getTime(format='float'))
        ...
        for thisComponent in selectNumbersComponents:
            if hasattr(thisComponent, "setAutoDraw"):
                thisComponent.setAutoDraw(False)
        thisExp.addData('selectNumbers.stopped', globalClock.getTime(format='float'))
        ...
        for thisDigitLoop in digitLoop:
            ...
            continueRoutine = True
            # update component parameters for each repeat
            thisExp.addData('ShowNumbers.started', globalClock.getTime(format='float'))
            ...
            for thisComponent in ShowNumbersComponents:
                if hasattr(thisComponent, "setAutoDraw"):
                    thisComponent.setAutoDraw(False)
            thisExp.addData('ShowNumbers.stopped', globalClock.getTime(format='float'))
    ...
    continueRoutine = True
    # update component parameters for each repeat
    thisExp.addData('FStoBStransition.started', globalClock.getTime(format='float'))
    moveToBS.keys = []
    moveToBS.rt = []
    _moveToBS_allKeys = []
    # keep track of which components have finished
    ...
    for thisComponent in FStoBStransitionComponents:
        if hasattr(thisComponent, "setAutoDraw"):
            thisComponent.setAutoDraw(False)
    thisExp.addData('FStoBStransition.stopped', globalClock.getTime(format='float'))
    # check responses
    ...
    continueRoutine = True
    # update component parameters for each repeat
    thisExp.addData('InstructionsBS.started', globalClock.getTime(format='float'))
    startBSprac.keys = []
    startBSprac.rt = []
    ...
    for thisComponent in InstructionsBSComponents:
        if hasattr(thisComponent, "setAutoDraw"):
            thisComponent.setAutoDraw(False)
    thisExp.addData('InstructionsBS.stopped', globalClock.getTime(format='float'))
    # check responses
    ...
    for thisTrialsPracticeBS in trialsPracticeBS:
        ...
        for thisDigitLoopPracticeBS in digitLoopPracticeBS:
            ...
            continueRoutine = True
            # update component parameters for each repeat
            thisExp.addData('showNumbersPracticeBS.started', globalClock.getTime(format='float'))
            ...
            for thisComponent in showNumbersPracticeBSComponents:
                if hasattr(thisComponent, "setAutoDraw"):
                    thisComponent.setAutoDraw(False)
            thisExp.addData('showNumbersPracticeBS.stopped', globalClock.getTime(format='float'))
            # using non-slip timing so subtract the expected duration of this Routine (unless ended on request)
            if routineForceEnded:
                routineTimer.reset()
            else:
        ...
        continueRoutine = True
        # update component parameters for each repeat
        thisExp.addData('recallPracticeBS.started', globalClock.getTime(format='float'))
        ...
        for thisComponent in recallPracticeBSComponents:
            if hasattr(thisComponent, "setAutoDraw"):
                thisComponent.setAutoDraw(False)
        thisExp.addData('recallPracticeBS.stopped', globalClock.getTime(format='float'))
        ...
        continueRoutine = True
        # update component parameters for each repeat
        thisExp.addData('feedbackPracticeBS.started', globalClock.getTime(format='float'))
        ...
        for thisComponent in feedbackPracticeBSComponents:
            if hasattr(thisComponent, "setAutoDraw"):
                thisComponent.setAutoDraw(False)
        thisExp.addData('feedbackPracticeBS.stopped', globalClock.getTime(format='float'))
        # using non-slip timing so subtract the expected duration of this Routine (unless ended on request)
        if routineForceEnded:
            routineTimer.reset()
        else:
    ...
    continueRoutine = True
    # update component parameters for each repeat
    thisExp.addData('startRealBS.started', globalClock.getTime(format='float'))
    startBSreal.keys = []
    startBSreal.rt = []
    ...
    for thisComponent in startRealBSComponents:
        if hasattr(thisComponent, "setAutoDraw"):
            thisComponent.setAutoDraw(False)
    thisExp.addData('startRealBS.stopped', globalClock.getTime(format='float'))
    # check responses
    ...
    for thisTrialsBS in trialsBS:
        ...
        continueRoutine = True
        # update component parameters for each repeat
        thisExp.addData('selectNumbersBS.started', globalClock.getTime(format='float'))
        ...
        for thisComponent in selectNumbersBSComponents:
            if hasattr(thisComponent, "setAutoDraw"):
                thisComponent.setAutoDraw(False)
        thisExp.addData('selectNumbersBS.stopped', globalClock.getTime(format='float'))
        ...
        for thisDigitLoopBS in digitLoopBS:
            ...
            continueRoutine = True
            # update component parameters for each repeat
            thisExp.addData('showNumbersBS.started', globalClock.getTime(format='float'))
            ...
            for thisComponent in showNumbersBSComponents:
                if hasattr(thisComponent, "setAutoDraw"):
                    thisComponent.setAutoDraw(False)
            thisExp.addData('showNumbersBS.stopped', globalClock.getTime(format='float'))
        ...
        continueRoutine = True
        # update component parameters for each repeat
        thisExp.addData('RecallBS.started', globalClock.getTime(format='float'))
        textboxBS.reset()
        ...
        for thisComponent in RecallBSComponents:
            if hasattr(thisComponent, "setAutoDraw"):
                thisComponent.setAutoDraw(False)
        thisExp.addData('RecallBS.stopped', globalClock.getTime(format='float'))
        ...
        continueRoutine = True
        # update component parameters for each repeat
        thisExp.addData('FeedbackBS.started', globalClock.getTime(format='float'))
        ...
        for thisComponent in FeedbackBSComponents:
            if hasattr(thisComponent, "setAutoDraw"):
                thisComponent.setAutoDraw(False)
        thisExp.addData('FeedbackBS.stopped', globalClock.getTime(format='float'))
        # using non-slip timing so subtract the expected duration of this Routine (unless ended on request)
        if routineForceEnded:
            routineTimer.reset()
        else:
